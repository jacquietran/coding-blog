---
title: '#WBBL07: At the halfway point'
author: Jacquie Tran
date: '2021-11-06'
slug: wbbl07-at-the-halfway-point
categories:
  - On-field analyses
tags:
  - women's sport
...
It's been a thrilling #WBBL07 so far - the competition seems well-balanced, with every team boasting world-class athletes alongside the tantalising skills of young guns who are the next wave of Australian talent coming through.

Coming off the back of the hotly contested Australia vs. India series, I have been glued to my screen and thought I might as well turn my attention to another screen instead - my computer screen - and take a closer look at some key performances so far this season.

# Getting started

I downloaded ball-by-ball match data from Cricsheet for the Women's Big Bash League (specifically using the CSV "Ashwin" format), focusing on games played so far in season 7 of the Women's Big Bash League (27 matches played between Oct 14 and Nov 3 2021).
...
# Run custom function fetch_cricsheet()
wbbl07_matches <- fetch_cricsheet("wbbl") %>%
...
wbbl07_tidy %>%
  # Exclude super overs because they're weird
