...
I am not immune to cynicism. On its face, this does not make for positive reading, and it is tempting for me to cry foul. Importantly, whenever I am interpreting the results of any analysis, I work to actively think about alternative interpretations and possible explanatory factors. Here are a few:
...
With a very quick inspection of the data at the observation-by-observation level, we now know that fewer Lead-level staff completed the questionnaire than Coach-level staff (26 versus 46, respectively). We also know that fewer Lead-level staff are working for clubs with first teams in the top tier leagues, whereas there are more Coach-level staff working at this level (7 versus 19 in absolute terms, 27% versus 40% as a proportion of respondents at the same job level). Perhaps what we see in the plot and table—the _appearance_ of no difference between these two job levels—is actually the 'league-level' effect obscuring real differences that may exist between the salaries of Coaches and Leads. Maybe?
...
We don't know. Not yet. With this data, we cannot confidently conclude that there is no difference but we also cannot conclude that there is a difference. We simply need more information and better information to arrive at a more definitive conclusion.

Nevertheless, I think there is enough of a query here to warrrant further exploration.
...
Enjoying the series so far? Constructive feedback and comments welcome via [Twitter: @jacquietran](www.twitter.com/jacquietran)